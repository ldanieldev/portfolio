...
export const Projects = [
  {
    slug: 'nextjs-store-admin-cms',
    categories: ['eCommerce', 'webApp', 'cms'],
    title: 'NextJS E-Commerce Store Admin CMS',
    summary:
      'A Full Stack E-Commerce CMS using NextJS, TailwindCss, Prisma, Stripe, & MySQL',
    description:
    ...
    featureImg: 'nextjs-store-admin-cms.png',
    liveUrl: 'https://nextjs-store-admin-cms.vercel.app/',
    codeUrl: 'https://github.com/ldanieldev/nextjs-store-admin-cms',
    projectDetails: [
    ...
    languages: [
      ...
      SkillLists.languages.skills.sql,
    ],
    frameworks: [
      SkillLists.frameworks.skills.react,
      SkillLists.frameworks.skills.nextJs,
      SkillLists.frameworks.skills.prisma,
      SkillLists.frameworks.skills.tailWindCss,
    ],
    tools: [SkillLists.tools.skills.MySQL],
    imageList: [
      '1.jpg',
      '2.jpg',
      '3.jpg',
  ...
  {
    slug: 'nextjs-cms-storefront',
    categories: ['eCommerce', 'webApp', 'website'],
    title: 'NextJS CMS StoreFront',
    summary:
      'An example storefront for a store created via the NextJs Admin CMS Project',
    description:
      'An example storefront for a store created via the NextJs Admin CMS Project ',
    featureImg: 'nextjs-cms-storefront.jpg',
    liveUrl: 'https://nextjs-cms-storefront.vercel.app/',
    codeUrl: 'https://github.com/ldanieldev/nextjs-cms-storefront',
    projectDetails: [
      'View categories & products setup from admin the cms project',
      'Ability to filters products by properties as category, color, and size',
      'Checkout via Stripe integration',
      'Database integration via MySQL + Prisma',
      'UI layout components via Headless UI',
      'Fully responsive design',
    ],
    languages: [
      SkillLists.languages.skills.html,
  ...
  },
  {
    ...
    summary:
      'An E-Commerce Store built with NextJS, MongoDB, Stripe, & Amazon S3',
    description:
    ...
    featureImg: 'nextjs-ecommerce-store.png',
    liveUrl: 'https://ldanieldev-nextjs-ecommerce.vercel.app/',
    codeUrl: 'https://github.com/ldanieldev/nextjs_ecommerce/',
    projectDetails: [
    ...
    frameworks: [
      SkillLists.frameworks.skills.shopify,
      SkillLists.frameworks.skills.react,
      SkillLists.frameworks.skills.nextJs,
      SkillLists.frameworks.skills.mongoose,
      SkillLists.frameworks.skills.tailWindCss,
    ],
    tools: [SkillLists.tools.skills.mongoDB],
    imageList: ['1.jpeg', '2.jpeg', '3.jpeg', '4.jpeg'],
  },
  {
    slug: 'react-house-marketplace',
    categories: ['eCommerce', 'webApp'],
    title: 'React House Marketplace App',
    summary: 'A mobile ready react project using firebase for data storage',
    description: 'A mobile ready react project using firebase for data storage',
    featureImg: 'react-house-marketplace.jpeg',
    liveUrl: 'https://react-house-marketplace.ldanieldev.com/',
    codeUrl: 'https://github.com/ldanieldev/react-house-marketplace',
    projectDetails: [
      'Google OAuth integration',
      'Listing map position determined from geolocation of listed address',
    ],
    languages: [
      SkillLists.languages.skills.html,
      SkillLists.languages.skills.css,
    ...
    frameworks: [SkillLists.frameworks.skills.react],
    tools: [SkillLists.tools.skills.firebase],
    imageList: ['1.jpeg', '2.jpeg'],
  },
  {
